...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        burguer=new Bote(300,10,"verde",2,500);
        opera_Pinta(burguer, metros);
        ...
        try {
            ...
            burguer.rellenar(verde, centilitros, centimos);
    ...
    private static void opera_Pinta(Bote burguer, int metros) {
        opera_Rellena(burguer, metros);
    }

    private static void opera_Rellena(Bote burguer, int metros) {
